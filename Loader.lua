...
local ThunderImageUI = Instance.new("ImageLabel")
        ...
        ThunderImageUI.Image = "rbxassetid://13918363155"
...
function Update:Window(text,logo,keybind)
	...
	local logo = logo or 13918363155
...
Logo.Image = " https://create.roblox.com/marketplace/asset/13918363155"
...
local Library = Update:Window("Hirimi HUB ","")
...
local Setting = Library:Tab(" ⚙️Settings","rbxassetid://11446835336")
...
Setting:Label("Please Subscribe Me")
...
Setting:Button("Subscribe To Channel Me",function()

 

 setclipboard("https://www.youtube.com/@hirimi0901")
...
Main:Label("Don't Turn Off Auto Click After Enable Auto Farm")
Main:Label("Đừng Tắt Auto Click Sau Khi Bật Auto Farm")



Main:Label("Decrypt By Hirimii")



Main:Label("Subscribe To Channel Hirimii🇻🇳")



Main:Label("Discord: https://discord.gg/rUKWhEJHf2")
...
Main:Button("Stop All Teleport",function()
...
Main:Toggle("Auto Click (obligatory)",true,function(value)
...
Main:Toggle("Farm Ectoplasm",_G.Auto_Farm_Ectoplasm,function(value)
...
Main:Toggle("Farm BF Mastery",_G.AutoFarmFruitMastery,function(value)
 ...
 Main:Toggle("Farm Gun Mastery",_G.AutoFarmGunMastery,function(value)
...
Main:Toggle("Farm Boss",_G.Auto_Farm_Boss,function(value)
...
Main:Toggle("Farm All Boss",_G.Auto_Farm_All_Boss,function(value)
...
Main:Toggle("Farm Material",_G.AutoFarmMaterial,function(t)
...
spawn(function()
    ...
    Mirragecheck:Set('🏝️ : Mystic Island is Spawning')
      ...
      Mirragecheck:Set('🏝️ : Mystic Island Not Found ❌')
...
Main:Toggle("Tween Mystic Island",false,function(value)
...
Main:Toggle("Tween Mystic Island Hop",false,function(value)
...
Main:Toggle("Farm Chest Fast",false,function(vu)
...
Main:Toggle("Farm Chest Tween",_G.Grab_Chest,function(vu)
...
Main:Button("Instant Tp Chest (Risk Kick)",function()
...
Main:Toggle("Farm Bone",_G.Auto_Farm_Bone,function(value)
...
Main:Toggle("Trade Bone",_G.Auto_Trade_Bone,function(value)
...
spawn(function()
	...
	while game:GetService("RunService").Heartbeat:wait() do
       ...
       Main:Toggle("Farm Observation",_G.AutoObservation,function(value)
    ...
    Main:Toggle("Farm Observation Hop",_G.AutoObservation_Hop,function(value)
...
Notification:Notify(
   ...
   {Title = "hirimii hub ", Description = "You Have Max Observation Point"},
...
local Elite_Hunter_Status = Weapon:Label("Status")
		...
		while wait() do
			...
			pcall(function()
				...
				if game:GetService("ReplicatedStorage"):FindFirstChild("Diablo [Lv. 1750]") or game:GetService("ReplicatedStorage"):FindFirstChild("Deandre [Lv. 1750]") or game:GetService("ReplicatedStorage"):FindFirstChild("Urban [Lv. 1750]") or game:GetService("Workspace").Enemies:FindFirstChild("Diablo [Lv. 1750]") or game:GetService("Workspace").Enemies:FindFirstChild("Deandre [Lv. 1750]") or game:GetService("Workspace").Enemies:FindFirstChild("Urban [Lv. 1750]") then
					...
					Elite_Hunter_Status:Set("Status : Elite Despawn")	
	...
	Weapon:Toggle("Kill Elite",_G.Auto_Elite_Hunter,function(value)
...
StopTween(_G.Auto_Elite_Hunter)
	...
	Weapon:Toggle("Kill Elite Hop",_G.Auto_Elite_Hunter_Hop,function(value)
...
Weapon:Toggle("Summon & Kill Cake Prince",_G.Auto_Cake_Prince,function(value)
...
StopTween(_G.Auto_Cake_Prince)
	...
	Weapon:Toggle("Summon & Kill Dough King",_G.Auto_Open_Dough_Dungeon,function(value)
...
Weapon:Toggle("Quest Soul Guitar",_G.AutoNevaSoulGuitar,function(value)
...
Weapon:Toggle("Done CDK Quest(Not Working)",_G.AutoCdk,function(value)
...
Weapon:Toggle("Auto Legendary Sword",_G.AutoBuyLegendarySword,function(Value)
		...
		Weapon:Toggle("Auto Legendary Sword Hop",_G.AutoBuySwordHop,function(Value)
...
Weapon:Toggle("Taken Swan Glasses",_G.Auto_Swan_Glasses,function(value)
...
StopTween(_G.Auto_Swan_Glasses)
	...
	Weapon:Toggle("Taken Swan Glasses Hop",_G.Auto_Swan_Glasses_Hop,function(value)
 ...
 _G.Auto_Swan_Glasses_Hop = value
	...
	Weapon:Toggle("Taken Dragon Trident",_G.Auto_Dragon_Trident,function(value)
...
StopTween(_G.Auto_Dragon_Trident)
	...
	Weapon:Toggle("Taken Dragon Trident Hop",_G.Auto_Dragon_Trident_Hop,function(value)
...
Weapon:Toggle("Kill Soul Reaper",_G.Auto_Soul_Reaper,function(value)
...
Weapon:Toggle("Kill Soul Reaper Hop",_G.Auto_Soul_Reaper_Hop,function(value)
...
StopTween(_G.Auto_Rainbow_Haki_Hop)
	...
	Weapon:Toggle("Taken Canvander",_G.Auto_Canvander,function(value)
...
StopTween(_G.Auto_Canvander)
	...
	Weapon:Toggle("Taken Canvander Hop",_G.Auto_Canvander_Hop,function(value)
...
StopTween(_G.Auto_Canvander_Hop)
	...
	Weapon:Toggle("Taken Twin Hook",_G.Auto_Twin_Hook,function(value)
...
StopTween(_G.Auto_Twin_Hook)
	...
	Weapon:Toggle("Taken Twin Hook Hop",_G.Auto_Twin_Hook_Hop,function(value)
...
Weapon:Toggle("Taken Serpent Bow",_G.Auto_Serpent_Bow,function(value)
...
StopTween(_G.Auto_Serpent_Bow)
	...
	Weapon:Toggle("Taken Serpent Bow Hop",_G.Auto_Serpent_Bow_Hop,function(value)
...
Weapon:Toggle("Taken Tushita Sword",_G.Autotushita,function(value)
...
Weapon:Toggle("Plug Holy Torch",_G.Auto_Holy_Torch,function(value)
...
Weapon:Toggle("Taken Observation Haki V2",_G.AutoObservationHakiV2,function(x)
...
Race:Toggle("Disabled Inf Stairs", nil, function(value)
  ...
  Race:Button("Complete Angel Trial",function(t)
  game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Workspace.Map.SkyTrial.Model.FinishPart.CFrame
  end)

  Race:Button("Complete Rabbit Trial",function(t)
...
Stats:Toggle("🔩+Stats Melee",_G.Auto_Stats_Melee,function(value)
...
Stats:Toggle("📏+Stats Defense",_G.Auto_Stats_Defense,function(value)
...
Stats:Toggle("⚔️+Stats Sword",_G.Auto_Stats_Sword,function(value)
...
Stats:Toggle("🔫+Stats Gun",_G.Auto_Stats_Gun,function(value)
...
Stats:Toggle("🍊+Stats Devil Fruit",_G.Auto_Stats_Devil_Fruit,function(value)
...
Stats:Button("Stat Refund - 2500 Fragments",function()
...
Teleport:Seperator(" WORLD ")
 ...
 Teleport:Button("BYPASS Teleport",function(value)
...
Dungeon:Button("Start Dungeon",function()
